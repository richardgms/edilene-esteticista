...
export function Transformations() {
    return (
        <section id="results" className="w-full py-12 md:py-24 px-4 bg-accent-light/7 flex flex-col items-center">
            <FadeIn>
                ...
                <p className="text-text-light text-center mb-6 md:mb-12 max-w-2xl text-balance mx-auto">
                    Resultados obtidos com protocolos exclusivos. Acompanhe a evolução real do Antes e Depois de nossas pacientes.
                </p>
            </FadeIn>
                                    ...
                                    {transform.description && (
                                        <div className="p-4 md:p-6 bg-secondary flex-grow flex flex-col justify-center relative">
                                            ...
                                            <div className="mt-4 flex justify-center opacity-50">
                                                <div className="w-12 h-px bg-accent-dark/60" />
                                            </div>
                                        </div>
                                    )}
                                </div>
