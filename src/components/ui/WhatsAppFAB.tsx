...
export function WhatsAppFAB() {
    ...
    return (
        <a
            ...
            className="fixed bottom-6 right-6 md:bottom-10 md:right-10 z-50 bg-accent-dark text-white p-3 md:p-4 rounded-full hover:scale-110 transition-transform duration-300 group flex items-center justify-center shadow-lg"
        ...
        >
            ...
            {/* Pulse effect */}
            <span className="absolute inset-0 bg-accent-dark rounded-full animate-ping opacity-75 -z-10" style={{ animationDuration: '2s' }}></span>
        </a>
    );
}
